...
<xsl:param name="corpus">XXX</xsl:param> <!-- the language code -->
    
<xsl:param name="webRoot">https://distantreading.github.io/ELTeC/</xsl:param> <!-- target website -->
    
<xsl:param name="repoRoot">/home/lou/Public/ELTeC-</xsl:param>  <!-- source files -->
<xsl:param name="gitRoot">https://raw.githubusercontent.com/COST-ELTeC/ELTeC-</xsl:param>
...
<xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html></xsl:text>       
  ...
  <!-- First we create metadata.csv file which Rscript will use to generate mosaic graphic -->              <xsl:result-document href="metadata.csv">
